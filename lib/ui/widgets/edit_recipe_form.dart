...
class EditRecipeForm extends StatefulWidget {
  final Recipe recipe;
  final Function(String jsonData) onSave;
...
class _EditRecipeFormState extends State<EditRecipeForm> {
  ...
  void _submitAll() {
    ...
    widget.onSave(jsonEncode(details));
  }
            ...
            children: [
              ...
              ...List.generate(4, (i) {
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: i == step ? _accent : (i < step ? _accent.withAlpha(160) : Colors.grey[300]),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(children: [
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(labelText: l10n.recipeYield, border: const OutlineInputBorder()),
              ),
            ),
          ]),
          const SizedBox(height: 12),
          Row(children: [
            Expanded(
              child: TextField(
                ...
                keyboardType: TextInputType.number,
                decoration: InputDecoration(labelText: l10n.totalTime, border: const OutlineInputBorder()),
              ),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: TextField(
                ...
                keyboardType: TextInputType.number,
                decoration: InputDecoration(labelText: l10n.prepTimeMinutes, border: const OutlineInputBorder()),
              ),
            ),
          ]),
          const SizedBox(height: 12),
          TextField(
            ...
            keyboardType: TextInputType.number,
            decoration: InputDecoration(labelText: l10n.cookTime, border: const OutlineInputBorder()),
          ),
          const SizedBox(height: 12),
          Row(children: [
          ...
          Row(children: [
            Expanded(
              child: OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(foregroundColor: Colors.black, side: BorderSide(color: Colors.grey[400]!)),
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(backgroundColor: _accent, foregroundColor: Colors.white, padding: const EdgeInsets.symmetric(vertical: 16, horizontal: 20)),
      ...
      child: Column(
        ...
        children: [
          ...
          if (_ingredients.isNotEmpty) ...[
            Text(l10n.ingredientsList, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
            ...
            Center(
              child: Padding(
                ...
                child: Text(l10n.noIngredientsAdded, style: TextStyle(color: Colors.grey[500], fontStyle: FontStyle.italic)),
              ),
            ),
          ],
          const SizedBox(height: 8),
          ...
          TextField(
            ...
            decoration: InputDecoration(labelText: l10n.notesOptional, border: const OutlineInputBorder(), contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 12)),
          ),
          const SizedBox(height: 8),
          SizedBox(
  ...
  Widget _buildExtrasStep() {
    final l10n = AppLocalizations.of(context)!;
    return SingleChildScrollView(
      key: const ValueKey('edit_step3'),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildStepIndicator(3),
          _buildChipSection(label: l10n.recipeCategories, hint: l10n.categoriesHint, controller: _categoryInputController, items: _categories, icon: Icons.category_outlined),
          const SizedBox(height: 16),
          _buildChipSection(label: l10n.tags, hint: l10n.tagsHint, controller: _tagInputController, items: _tags, icon: Icons.label_outline),
          const SizedBox(height: 16),
          _buildChipSection(label: l10n.tools, hint: l10n.toolsHint, controller: _toolInputController, items: _tools, icon: Icons.handyman_outlined),
          const SizedBox(height: 16),

          // Instructions
          Text(l10n.instructionsPerStep, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
          const SizedBox(height: 8),
          if (_instructionSteps.isNotEmpty) ...[
            ...
            Center(child: Padding(padding: const EdgeInsets.symmetric(vertical: 8), child: Text(l10n.noInstructionsAdded, style: TextStyle(color: Colors.grey[500], fontStyle: FontStyle.italic)))),
          ],
          Row(children: [
            Expanded(
              child: TextField(
          ...
          TextField(
            ...
            maxLines: 3,
            decoration: InputDecoration(labelText: l10n.recipeNote, hintText: l10n.recipeNoteHint, border: const OutlineInputBorder(), alignLabelWithHint: true),
          ),
          const SizedBox(height: 16),
